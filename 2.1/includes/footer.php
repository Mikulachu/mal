                ...
                <div class="footer__grid">
                    ...
                    <div class="footer__col">
                        ...
                        <div class="footer__social">
                            <a href="https://www.facebook.com/MALTECHNIK.Chojnice?locale=pl_PL" class="social__link" aria-label="Facebook">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/maltechnik.chojnice/" class="social__link" aria-label="Instagram">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://www.youtube.com/@Maltechnik.Chojnice" class="social__link" aria-label="YouTube">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
